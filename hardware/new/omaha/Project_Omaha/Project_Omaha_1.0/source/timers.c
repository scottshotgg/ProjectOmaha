...
void initializeTimers(){
	...
	GpioCtrlRegs.GPAMUX1.bit.GPIO3 = 0;	   //GPIO 5 is used as the TX enable pin on RS485/UART transiever for SCIA
	GpioCtrlRegs.GPADIR.bit.GPIO3 = 1;
	GpioCtrlRegs.GPAMUX1.bit.GPIO5 = 0;	  //GPIO 3 is ued as the TX enable pin on RS485/UART transiever for SCIB
