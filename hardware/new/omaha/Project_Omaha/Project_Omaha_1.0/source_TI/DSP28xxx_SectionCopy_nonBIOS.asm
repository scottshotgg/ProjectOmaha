...
copy_sections:
	...
	MOVL XAR5,#_Cla1funcsLoadSize				; Store Section Size in XAR5
	MOVL ACC,@XAR5						; Move Section Size to ACC
	MOVL XAR6,#_Cla1funcsLoadStart			; Store Load Starting Address in XAR6
    MOVL XAR7,#_Cla1funcsRunStart		; Store Run Address in XAR7
    LCR  copy							; Branch to Copy 
